...
@InputType()
class SubjectCreateNestedManyWithoutDepartmentsInput {
...
export { SubjectCreateNestedManyWithoutDepartmentsInput as SubjectCreateNestedManyWithoutDepartmentsInput };
