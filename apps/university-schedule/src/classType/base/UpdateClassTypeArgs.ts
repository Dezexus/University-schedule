...
class UpdateClassTypeArgs {
  ...
  @ApiProperty({
    required: true,
    type: () => ClassTypeUpdateInput,
  })
  @ValidateNested()
  @Type(() => ClassTypeUpdateInput)
  @Field(() => ClassTypeUpdateInput, { nullable: false })
  data!: ClassTypeUpdateInput;
}

export { UpdateClassTypeArgs as UpdateClassTypeArgs };
