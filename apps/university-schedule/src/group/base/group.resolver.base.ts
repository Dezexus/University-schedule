...
export class GroupResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Subgroup], { name: "subgroups" })
  @nestAccessControl.UseRoles({
    resource: "Subgroup",
    action: "read",
    possession: "any",
  ...
  async findSubgroups(
    ...
    const results = await this.service.findSubgroups(parent.id, args);
  ...
  @graphql.Mutation(() => NewGroupCreateInput)
  async CreateGroup(
    @graphql.Args()
    args: NewGroupCreateInput
  ): Promise<NewGroupCreateInput> {
    return this.service.CreateGroup(args);
  }

  @graphql.Mutation(() => NewRoomWhereUniqueInput)
  async DeleteGroup(
    @graphql.Args()
    args: NewRoomWhereUniqueInput
  ): Promise<NewRoomWhereUniqueInput> {
    return this.service.DeleteGroup(args);
  }

  @graphql.Mutation(() => NewGroupUpdateInput)
  async UpdateGroup(
    @graphql.Args()
    args: NewGroupUpdateInput
  ): Promise<NewGroupUpdateInput> {
    return this.service.UpdateGroup(args);
  }
}
