...
export class RoomResolverBase {
  ...
  @graphql.Mutation(() => NewRoomCreateInput)
  async CreateRoom(
    @graphql.Args()
    args: NewRoomCreateInput
  ): Promise<NewRoomCreateInput> {
    return this.service.CreateRoom(args);
  }
  ...
  async DeleteRoom(
    ...
    return this.service.DeleteRoom(args);
  }

  @graphql.Mutation(() => NewRoomUpdateInput)
  async UpdateRoom(
    @graphql.Args()
    args: NewRoomUpdateInput
  ): Promise<NewRoomUpdateInput> {
    return this.service.UpdateRoom(args);
  }
}
